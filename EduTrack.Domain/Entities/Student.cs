...
public class Student
{
    ...
    [Column(TypeName = "varchar")] public string Name { get; set; }
    [Column(TypeName = "varchar")] public string LastName { get; set; }
    public int Age { get; set; }
    [Column(TypeName = "varchar")] public string DocNumber { get; set; }
    [Column(TypeName = "varchar")] public string Email { get; set; }
    [Column(TypeName = "varchar")] public string PhoneNumber { get; set; }
